...
Header kolom ikut diperjelas: **"Harga Terakhir (Rp/unit)"** (menegaskan harga
per satuan, bukan nilai posisi) dan **"Laba/Rugi (P/L)"** (singkatan "P/L" saja
tidak memberi tahu pembaca baru bahwa itu laba/rugi).
