...
(`BOOKING_BAR_CLASSES.paid`), indikator hijau pindah ke **nominal harga** sel (hanya malam booking
LUNAS via `paidPriceByDate`); **Confirmed** = chip indigo; **Inquiry** = chip kuning; harga sel
