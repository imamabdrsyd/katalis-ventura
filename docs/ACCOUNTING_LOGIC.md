...
**Yang sengaja TIDAK dilakukan.** Data real mengonfirmasi elvéa Indonesia — satu-satunya
bisnis yang benar-benar melacak stok (11 item) — mencatat **seluruh 44 pembelian stoknya
langsung ke `5200 Variable Cost (COGS)`** dan tidak punya akun Persediaan sama sekali. Model
itu (beban-saat-beli) sudah konsisten dengan dirinya sendiri; menambahkan auto-HPP saat jual
justru akan **menghitung beban dua kali**. Karena itu gerbang "punya akun Persediaan" bukan
sekadar penjaga null — ia yang menentukan kebenaran. Konsekuensinya fitur ini memang tidak
aktif untuk elvéa sampai mereka memilih pindah ke persediaan perpetual; form katalog
menjelaskan hal ini alih-alih membiarkan field harga pokok diam-diam tak berefek.
