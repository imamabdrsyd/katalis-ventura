...
**Proteksi double-booking:** `findOverlappingBookings()` (dua rentang beririsan bila
`aIn < bOut AND aOut > bIn`, exclude `cancelled` & diri sendiri) dipanggil saat form berubah;
tombol simpan diblok bila bentrok untuk unit yang sama.
