...
```
1. Jika is_multi_line && journal_lines ada:
     return ada baris credit_amount > 0 yang akunnya LIABILITY

2. Else jika is_double_entry:
     return credit_account LIABILITY DAN namanya cocok /hutang|utang|payable/i
