...
Layer 2: API-side (app/api/transactions/)
  ...
  → Postable-draft guard (isPostableDraft): draft belum lengkap tidak bisa
    di-post (butuh amount>0 + akun debit & kredit terisi & berbeda) —
