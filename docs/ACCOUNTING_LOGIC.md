...
|-------|-------------------|
| Avg Price | **rumus** asal valuasi: "Aset − Liabilitas" (tooltip menjelaskan = nilai buku bisnis target) |
| Last Price | nominal valuasi (`totalEquity`) + label kecil "Valuasi Bisnis" |
