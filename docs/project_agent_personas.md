...
- Punya akses 5 tools: `query_transactions`, `get_financial_summary`, `get_contacts`, `get_business_info`, `navigate_to`
...
- `src/lib/ai/agentTools.ts` — definisi & eksekusi 5 tools
