...
export function Modal({ isOpen, onClose, title, children, footer }: ModalProps) {
  ...
  const modalContent = (
    ...
    >
      <div
        className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-[calc(100vw-2rem)] sm:max-w-md max-h-[90vh] flex flex-col animate-in fade-in zoom-in-95 duration-200"
