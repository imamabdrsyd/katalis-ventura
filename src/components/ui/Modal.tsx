  ...
  const modalContent = (
    ...
    >
      <div className="relative flex items-center" onClick={(e) => e.stopPropagation()}>
        ...
        {sideNavPrev && (
          <button
            onClick={sideNavPrev.onClick}
            disabled={sideNavPrev.disabled}
            title={sideNavPrev.title}
            className="absolute -left-14 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-white/90 dark:bg-gray-700/90 shadow-lg text-gray-600 dark:text-gray-300 hover:bg-white dark:hover:bg-gray-600 disabled:opacity-25 disabled:cursor-not-allowed transition-all"
          >
        ...
        {sideNavNext && (
          <button
            onClick={sideNavNext.onClick}
            disabled={sideNavNext.disabled}
            title={sideNavNext.title}
            className="absolute -right-14 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-white/90 dark:bg-gray-700/90 shadow-lg text-gray-600 dark:text-gray-300 hover:bg-white dark:hover:bg-gray-600 disabled:opacity-25 disabled:cursor-not-allowed transition-all"
          >
