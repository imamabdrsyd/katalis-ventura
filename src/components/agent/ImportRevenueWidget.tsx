...
export function ImportRevenueWidget({
  ...
  return (
    <div className="rounded-2xl border border-transparent dark:border-gray-700 bg-white dark:bg-gray-800 shadow-card overflow-hidden transition-all duration-200 hover:shadow-card-hover dark:hover:border-gray-600 hover:-translate-y-1">
      {/* Widget header */}
