  ...
  return (
    <div className="relative group">
      <span ref={ref} className="line-clamp-2 cursor-default">
        {catalogName && (
          <span className="inline-flex items-center max-w-full px-2 py-0.5 mr-1.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 align-middle">
