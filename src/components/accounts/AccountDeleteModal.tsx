...
export function AccountDeleteModal({
  ...
  return (
    <AnimatedDialog
      ...
      panelClassName="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full"
    ...
    >
      <div className="p-6">
        ...
        {/* Title */}
        <h3 id={titleId} className="text-xl font-bold text-center text-gray-900 dark:text-gray-100 mb-2">
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3">
          {isSystemAccount ? (
            ...
            <>
              ...
              <button
                onClick={onConfirm}
                className="flex-1 px-4 py-2 bg-red-500 dark:bg-red-600 text-white font-medium rounded-lg hover:bg-red-600 dark:hover:bg-red-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={loading}
              >
