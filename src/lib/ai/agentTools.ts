 ...
 * get_business_info, navigate_to, search_knowledge_base
 *
 * Catatan: `run_olap_analytics` & `recall_memory` DICABUT 19 Agustus 2026 —
 * keduanya membaca instance Cloud SQL GCP `axion-agents` yang sudah dihapus
 * 10 Agustus 2026 untuk menolkan tagihan.
 */
