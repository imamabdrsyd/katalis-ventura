...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  OPEX: 'text-red-500 dark:text-red-400',
  VAR: 'text-orange-500 dark:text-orange-400',
  CAPEX: 'text-blue-500 dark:text-blue-400',
  TAX: 'text-purple-500 dark:text-purple-400',
  FIN: 'text-indigo-500 dark:text-indigo-400',
};
