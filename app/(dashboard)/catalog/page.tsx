...
import {
  Plus, Search, Package, Wrench, Pencil, Trash2, X,
  PackageOpen, EyeOff,
} from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-3">
              <PackageOpen className="w-7 h-7 text-indigo-500 dark:text-indigo-400" />
              {tc.title}
            </h1>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {item.revenue_account && (
                      <p className="text-xs text-gray-400 dark:text-gray-500 truncate mt-0.5">
                        {item.revenue_account.account_code} - {item.revenue_account.account_name}
                      </p>
                    )}
                  </div>
                </div>
